    ...
    return(
        <div className="relative h-[91svh] w-full" onClick={()=>setImgIdx(prev => (prev+1)%4)}>
            ...
            <div className="absolute top-16 left-1/2 -translate-x-1/2 pt-6 pb-4 pl-2 pr-2 w-[90%] text-center rounded-sm bg-white/40 backdrop-blur-md shadow-xl z-50">
                <h1 className="text-5xl mb-3 md:mb-4 2xl:text-7xl">Hotel Booking</h1>
                <p className="text-xl md:text-2xl font-light  2xl:text-3xl">Fast and Easy - For you to spend your time enjoying your vacation</p>
            </div>

            <button onClick={(e)=>{e.stopPropagation(); router.push("/hotel")}} className="
                absolute font-[100] text-4xl translate-x-1/2 right-1/2 bottom-12 w-[70%] h-fit p-3 rounded-lg bg-white/30 backdrop-blur-md shadow-xl z-40 
