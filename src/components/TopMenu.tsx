            ...
            <DrawerPanel>
                {
                    session
                        ?   <Link href={"/api/auth/signout"} className="w-full h-fit p-2 pl-3 pr-3 mt-auto mb-auto text-center text-gray-100
                            text-md font-bold hover:bg-slate-700 sm:text-lg md:text-xl 2xl:text-2xl" underline="none">
                                <div>Sign-Out</div>
                            </Link>
                ...
                <Link href="/booking" className="w-full text-center p-2 pl-3 pr-3 font-semibold text-md no-underline hover:bg-slate-700 text-gray-100
