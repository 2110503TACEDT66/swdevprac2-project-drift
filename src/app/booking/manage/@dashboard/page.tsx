...
export default async function DashboardPage() {
    ...
    return (
        <main className=" mt-5 mx-auto space-y-7 px-3 w-full">
            <table className="bg-slate-100 mx-auto table-auto border-separate border-spacing-2 p-3 rounded-md max-w-xl">
                <tbody>
...

            {
                ...
                <form action={addHotel} className="flex flex-col flex-nowrap mx-auto max-w-[600px] bg-slate-100 rounded-md p-3">
                    <div className="text-xl text-blue-700">Create Hotel</div>
                    <div className="flex mx-auto w-[95%] max-w-[500px] my-2">
                    ...
                    <div className="flex mx-auto w-[95%] max-w-[500px] my-2">
                        ...
                        <div className="flex mx-auto items-center w-[95%] max-w-[500px] my-2">
                    ...
                    <button type="submit" 
                        className="bg-blue-500 mx-auto mt-3 hover:bg-blue-600 text-white p-2 w-[95%] max-w-[450px] rounded transition-colors"
                    >
                        Add New Hotel
                    </button>
                </form>
